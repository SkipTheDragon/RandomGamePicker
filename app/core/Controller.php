...
class Controller extends Base
{
     ...
     * @throws Exception
     */
    public function model($model/*, $namespace = 'core'*/)
    {
       /* $modelt = ucfirst($model);
        $namespacet = ucfirst($namespace);
        $comb = $namespacet.'\\'.$modelt;
        
        if (is_readable('app/models/'.$namespace.'/'. $model .'.php')) {
            require_once 'app/models/'.$namespace.'/'. $model .'.php'; */
